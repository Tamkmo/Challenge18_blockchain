...
@dataclass
class Record:
    # Define the parameters that the Record class will hold    
...
def setup():
      ...
      record = Record(amount =100, sender = 'sarah', receiver = 'molly')
      block = Block(record=record, creator_id=42, prev_hash='0')
      return PyChain(chain=[block])
